...
public class UserCtrl extends HttpServlet {
    ...
    private void loginUser(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (user != null) {
            ...
            // Check if there's a redirect parameter for payment
            String redirect = request.getParameter("redirect");
            String carId = request.getParameter("carId");
            
            if ("payment".equals(redirect) && carId != null) {
                // Redirect to payment page if user came from car rental
                response.sendRedirect(request.getContextPath() + "/user/payment/payment.jsp?carId=" + carId);
